...
![блок-схема](блок-схемы\метод_создания_массива.png)
...
___
![длина_нового_массива](блок-схемы\поиск_длины.png)
...
![новый_массив](блок-схемы\новый_массив.png)
...
## Все схемы
___
![все_схемы](блок-схемы\методы_отдельно.png)
